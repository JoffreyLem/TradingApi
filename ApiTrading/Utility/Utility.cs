...
namespace Utility
{
    public static class Utility
    {
        ...
        public static StatusPosition GetStatusPositionByStreamingTradeType(this long tradeType)
        {
            switch (tradeType)
            {
                case 0L:
        ...
        public static TypePosition ConvertCmdToType(this long cmd)
        {
            switch (cmd)
            {
                case 0:
        ...
        public static TypePosition? GetTypePositionBySignal(this Signal signal)
        {
