namespace XtbLibrairie.commands
{
    ...
    public class APICommandFactory
    {
        ...
        public static ChartLastCommand CreateChartLastCommand(string symbol, PERIOD_CODE period, long? start,
        ...
        public static ChartRangeCommand CreateChartRangeCommand(string symbol, PERIOD_CODE period, long? start,
            long? end, long? ticks, bool prettyPrint = false)
        {
            var args = new JSONObject();
        ...
        public static CommissionDefCommand CreateCommissionDefCommand(string symbol, double? volume,
            bool prettyPrint = false)
        {
            var args = new JSONObject();
        ...
        public static ProfitCalculationCommand CreateProfitCalculationCommand(string symbol, double? volume,
        ...
        public static TickPricesCommand CreateTickPricesCommand(List<string> symbols, long? timestamp,
            bool prettyPrint = false)
        {
            var args = new JSONObject();
        ...
        public static TradeTransactionCommand CreateTradeTransactionCommand(TradeTransInfoRecord tradeTransInfo,
            bool prettyPrint = false)
        {
            var args = new JSONObject();
        ...
        public static TradeTransactionCommand CreateTradeTransactionCommand(TRADE_OPERATION_CODE cmd,
            TRADE_TRANSACTION_TYPE type, double? price, double? sl, double? tp, string symbol, double? volume,
            long? order, string customComment, long? expiration, bool prettyPrint = false)
        {
            var args = new JSONObject();
        ...
        public static TradeTransactionCommand CreateTradeTransactionCommand(TRADE_OPERATION_CODE cmd,
            TRADE_TRANSACTION_TYPE type, double? price, double? sl, double? tp, string symbol, double? volume,
            long? ie_deviation, long? order, string comment, long? expiration, bool prettyPrint = false)
        {
            return CreateTradeTransactionCommand(cmd, type, price, sl, tp, symbol, volume, order, "", expiration);
        }

        public static TradeTransactionStatusCommand CreateTradeTransactionStatusCommand(long? order,
            bool prettyPrint = false)
        {
            var args = new JSONObject();
        ...
        public static ChartLastResponse ExecuteChartLastCommand(SyncAPIConnector connector, ChartLastInfoRecord info,
            bool prettyPrint = false)
        {
            return new ChartLastResponse(connector.ExecuteCommand(CreateChartLastCommand(info, prettyPrint))
                .ToString());
        }

        public static ChartLastResponse ExecuteChartLastCommand(SyncAPIConnector connector, string symbol,
        ...
        public static ChartRangeResponse ExecuteChartRangeCommand(SyncAPIConnector connector, ChartRangeInfoRecord info,
            bool prettyPrint = false)
        {
            return new ChartRangeResponse(connector.ExecuteCommand(CreateChartRangeCommand(info, prettyPrint))
                .ToString());
        }

        public static ChartRangeResponse ExecuteChartRangeCommand(SyncAPIConnector connector, string symbol,
        ...
        public static CommissionDefResponse ExecuteCommissionDefCommand(SyncAPIConnector connector, string symbol,
            double? volume, bool prettyPrint = false)
        {
            return new CommissionDefResponse(connector
                .ExecuteCommand(CreateCommissionDefCommand(symbol, volume, prettyPrint)).ToString());
        }

        public static IbsHistoryResponse ExecuteIbsHistoryCommand(SyncAPIConnector connector, long start, long end,
            bool prettyPrint = false)
        {
        ...
        [Obsolete("Up from 2.3.3 login is not a long, but string")]
        public static LoginResponse ExecuteLoginCommand(SyncAPIConnector connector, long userId, string password,
            bool prettyPrint = false)
        {
            return ExecuteLoginCommand(connector, userId.ToString(), password, prettyPrint);
        }

        public static LoginResponse ExecuteLoginCommand(SyncAPIConnector connector, string userId, string password,
            bool prettyPrint = false)
        {
        ...
        public static LoginResponse ExecuteLoginCommand(SyncAPIConnector connector, Credentials credentials,
            bool prettyPrint = false)
        {
            ...
            while (loginResponse.RedirectRecord != null)
            {
                ...
                var newServer = new Server(loginResponse.RedirectRecord.Address, loginResponse.RedirectRecord.MainPort,
                    ...
                    "Redirected to: " + loginResponse.RedirectRecord.Address + ":" +
                    loginResponse.RedirectRecord.MainPort + "/" + loginResponse.RedirectRecord.StreamingPort);
        ...
        public static MarginLevelResponse ExecuteMarginLevelCommand(SyncAPIConnector connector,
            bool prettyPrint = false)
        {
            return new MarginLevelResponse(connector.ExecuteCommand(CreateMarginLevelCommand(prettyPrint)).ToString());
        }

        public static MarginTradeResponse ExecuteMarginTradeCommand(SyncAPIConnector connector, string symbol,
            double? volume, bool prettyPrint)
        {
            return new MarginTradeResponse(connector
                .ExecuteCommand(CreateMarginTradeCommand(symbol, volume, prettyPrint)).ToString());
        }

        public static NewsResponse ExecuteNewsCommand(SyncAPIConnector connector, long? start, long? end,
            bool prettyPrint = false)
        {
        ...
        public static CurrentUserDataResponse ExecuteCurrentUserDataCommand(SyncAPIConnector connector,
            bool prettyPrint = false)
        {
        ...
        public static ProfitCalculationResponse ExecuteProfitCalculationCommand(SyncAPIConnector connector,
            string symbol, double? volume, TRADE_OPERATION_CODE cmd, double? openPrice, double? closePrice,
            bool prettyPrint = false)
        {
        ...
        [Obsolete("Command not available in API any more")]
        public static AllSymbolGroupsResponse ExecuteSymbolGroupsCommand(SyncAPIConnector connector,
            bool prettyPrint = false)
        {
            return null;
        }
        ...
        public static SymbolResponse ExecuteSymbolCommand(SyncAPIConnector connector, string symbol,
            bool prettyPrint = false)
        {
            return new SymbolResponse(connector.ExecuteCommand(CreateSymbolCommand(symbol, prettyPrint)).ToString());
        }

        public static TickPricesResponse ExecuteTickPricesCommand(SyncAPIConnector connector, List<string> symbols,
            long? timestamp, bool prettyPrint = false)
        {
            return new TickPricesResponse(connector
                .ExecuteCommand(CreateTickPricesCommand(symbols, timestamp, prettyPrint)).ToString());
        }

        public static TradeRecordsResponse ExecuteTradeRecordsCommand(SyncAPIConnector connector,
            LinkedList<long?> orders, bool prettyPrint = false)
        {
            return new TradeRecordsResponse(connector.ExecuteCommand(CreateTradeRecordsCommand(orders, prettyPrint))
                .ToString());
        }

        public static TradeTransactionResponse ExecuteTradeTransactionCommand(SyncAPIConnector connector,
        ...
        {
            return new TradeTransactionResponse(connector.ExecuteCommand(CreateTradeTransactionCommand(cmd, type, price,
                sl, tp, symbol, volume, order, customComment, expiration, prettyPrint)).ToString());
        }

        [Obsolete("Method outdated. ie_deviation is not available any more")]
        public static TradeTransactionResponse ExecuteTradeTransactionCommand(SyncAPIConnector connector,
            TRADE_OPERATION_CODE cmd, TRADE_TRANSACTION_TYPE type, double? price, double? sl, double? tp, string symbol,
            double? volume, long? ie_deviation, long? order, string comment, long? expiration, bool prettyPrint = false)
        {
            return new TradeTransactionResponse(connector
                .ExecuteCommand(CreateTradeTransactionCommand(cmd, type, price, sl, tp, symbol, volume, order, "",
                    expiration, prettyPrint)).ToString());
        }

        public static TradeTransactionStatusResponse ExecuteTradeTransactionStatusCommand(SyncAPIConnector connector,
            long? order, bool prettyPrint = false)
        {
        ...
        public static TradesResponse ExecuteTradesCommand(SyncAPIConnector connector, bool openedOnly,
            bool prettyPrint = false)
        {
            return new TradesResponse(connector.ExecuteCommand(CreateTradesCommand(openedOnly, prettyPrint))
                .ToString());
        }

        public static TradesHistoryResponse ExecuteTradesHistoryCommand(SyncAPIConnector connector, long? start,
            long? end, bool prettyPrint = false)
        {
            return new TradesHistoryResponse(connector
                .ExecuteCommand(CreateTradesHistoryCommand(start, end, prettyPrint)).ToString());
        }

        public static TradingHoursResponse ExecuteTradingHoursCommand(SyncAPIConnector connector, List<string> symbols,
            bool prettyPrint = false)
        {
