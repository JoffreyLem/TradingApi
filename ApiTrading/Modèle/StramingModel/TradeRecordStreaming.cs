...
namespace Modele.StramingModel
{
    ...
    public class TradeRecordStreaming
    {
        ...
        public TypePosition Cmd { get; set; }
        ...
        public StatusPosition Type { get; set; }
        ...
        public void XtbParsing(JSONObject value)
        {
            ...
            Cmd = XtbModelHelper.GetTypePosition((long?) value["cmd"]);
            ...
            Type = XtbModelHelper.GetStatusPosition((long?) value["type"]);
            Sl = (double?) value["sl"];
